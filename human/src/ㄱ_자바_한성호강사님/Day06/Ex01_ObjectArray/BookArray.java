package ㄱ_자바_한성호강사님.Day06.Ex01_ObjectArray;
...
public class BookArray {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < bookArray.length; i++) {
			...
			// 아래의 내용을 위 내용으로 축약할 수 있음!! Gooooood!
			//Book book = new Book( title, author );	// 이걸(전달인자) 사용하려면 생성자 필요함!
													// 두개의 인자를 기본값을 생성하기 위해 생성자 만듦!
			//bookArray[i] = book;
